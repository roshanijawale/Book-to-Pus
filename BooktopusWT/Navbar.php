...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="height:60px;">
        <div class="container">
            ...
            <form action="ajax-db-search.php">  
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
						<?php
							...
							{
						?>
                        <a href="Notification.php" class="nav-link" style="color:white;">Notification</a>
						<?php
							}
                
                            else{
						?>
						<a href="login.php" class="nav-link" style="color:white;">Notification</a>
                    ...
                    <li class="nav-item">
                        <a href="Upload_Book.php" class="nav-link" style="color:white;">Upload Book</a>
                    </li>
                    <li class="nav-item">
                        <a href="History.php" class="nav-link" style="color:white;">Profile</a>
                    </li>
                    <?php
                        if(isset($_SESSION["login_id"]))
                        {
